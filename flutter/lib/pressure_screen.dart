...
class _PressureScreenState extends State<PressureScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Pressure Sensor'), // Title of the AppBar
      ...
      body: Stack(
        ...
        children: [
          // Background image
          Image.asset(
            'assets/images/9cbf6ff00fe8fc4f3317d3713b16672e1.jpg', 
            fit: BoxFit.cover, 
          ),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Icon(Icons.speed, color: Colors.redAccent), // Icon for pressure data
                                      SizedBox(width: 10),
                                      Text(
                                        'Pressure: ${sensorData.pressure} mmHg', // Display pressure data
                                        style: TextStyle(
                                          fontSize: 24,
